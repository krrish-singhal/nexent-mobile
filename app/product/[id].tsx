...
const ProductDetailScreen = () => {
  ...
  return (
    <SafeScreen>
          ...
          {product.returnPolicy && (
            <View className="flex-row gap-2 mb-4">
              {product.returnPolicy.returnable && (
                <View className="bg-green-500/20 px-4 py-2 rounded-full flex-row items-center">
                  <Ionicons name="shield-checkmark" size={16} color="#10b981" />
                  <Text className="text-green-500 text-sm font-semibold ml-1">
                    {product.returnPolicy.returnDays}-Day Return
                  </Text>
                </View>
              )}
              {product.returnPolicy.refundable ? (
                <View className="bg-blue-500/20 px-4 py-2 rounded-full flex-row items-center">
                  <Ionicons name="cash" size={16} color="#3b82f6" />
                  <Text className="text-blue-500 text-sm font-semibold ml-1">
                    Refundable
                  </Text>
                </View>
              ) : (
                <View className="bg-red-500/20 px-4 py-2 rounded-full flex-row items-center">
      ...
      {/* Bottom Action Bar */}
      <View className="absolute bottom-7 left-0 right-0 bg-background/95 backdrop-blur-xl border-t border-surface px-6 py-4 pb-8">
