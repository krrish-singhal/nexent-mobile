...
const ProfileScreen = () => {
  ...
  // Fetch user profile from backend to get custom profile image
  ...
  // Use custom profile image if available, otherwise fall back to Clerk image
  const profileImage = profile?.profileImage || user?.imageUrl;
